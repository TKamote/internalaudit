...
const APP_LIST_DATA: AppListItem[] = [
  ...
  { id: "2", title: "Property Inspection", screenName: "BuildingInspectionsDaily" as any }, // Cast to any if not in AppStackParamList yet
  ...
  { id: "4", title: "Monthly Fire Extinguisher Inspection", screenName: "BuildingInspectionsMonthly" as any },// Cast to any if not in AppStackParamList yet
